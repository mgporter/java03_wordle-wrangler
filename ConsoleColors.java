public class ConsoleColors {
    ...
    public String colorSlot(LetterSlot slot) {
        if (slot.isGray()) {
            return WHITE + slot.getLetter() + RESET;
        } else if (slot.isYellow()) {
            return YELLOW + slot.getLetter() + RESET;
        } else if (slot.isGreen()) {
            return GREEN + slot.getLetter() + RESET;
        } else {
            return " ";
        }
    }
